...
test.describe('GCASH DEPOSIT WORKFLOW', () => {
    ...
    test('API AND CHECKOUT PAGE VALIDATION', async ({ browser }) => {
        ...
        await runStatusCodeChecker(gcashSolution, 'Gcash', VENDOR.UPAY, SHEET_NAME.E_WALLET);
        await runNoErrorChecker(gcashSolution, 'Gcash', VENDOR.UPAY, SHEET_NAME.E_WALLET);
        await runSuccessFlagChecker(gcashSolution, 'Gcash', VENDOR.UPAY, SHEET_NAME.E_WALLET);
        await runCheckoutUrlChecker(gcashSolution, 'Gcash', VENDOR.UPAY, SHEET_NAME.E_WALLET);
