...
test.describe('BKASH DEPOSIT WORKFLOW', () => {
    ...
    test.beforeAll(async () => {
        ...
        bkashSolution = await DepositIntentRequest({ 
            solutionConfig: E_WALLET_SOLUTIONS.bKash,
            apiKeys: {
    ...
    test('API AND CHECKOUT PAGE VALIDATION', async ({ browser }) => {
        ...
        try {
            ...
            await page.goto(bkashSolution.checkoutUrl, { waitUntil: 'networkidle', timeout: 80000 });
