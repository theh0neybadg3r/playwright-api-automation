...
const e_Wallet_Solutions = Object.entries(ALL_PAYMENT_METHODS.E_WALLET);

for (const [solution_name, solution_config] of e_Wallet_Solutions) {
    ...
    test.describe(`${solution_name} - Workflow`, () => {
        ...
        test.describe('API - Deposit Checker', () => {
            ...
            test('should have valid status code', async () => {
                ...
                const statusCodeResult = STATUS_CODE_CHECKER(apiResponseData, apiResponseTime, refId, solution_name, VENDOR.COINSPH, SHEET_NAME.E_WALLET)
            ...
            test('should have no error message in response', async () => {
                ...
                const noErrorInResponseResult =  NO_ERROR_RESPONSE_CHECKER(apiResponseData, solution_name, VENDOR.COINSPH, SHEET_NAME.E_WALLET)
            ...
            test('should have a success flag true', async () => {
                ...
                const successFlagResult = SUCCESS_FLAG_CHECKER(apiResponseData, solution_name, VENDOR.COINSPH, SHEET_NAME.E_WALLET);
            ...
            test('should have a valid Checkout URL', async () => {
                ...
                const checkoutUrlResult = CHECKOUT_URL_CHECKER(apiResponseData, solution_name, VENDOR.COINSPH, SHEET_NAME.E_WALLET);
            ...
            test('should load checkout page without errors', async ({ page }) => {
                ...
                const checkoutPageLoadResult = CHECKOUT_PAGE_CHECKER(foundErrorsInCheckoutPage, pageLoadTime, checkoutUrl, solution_name, VENDOR.COINSPH, SHEET_NAME.E_WALLET);
